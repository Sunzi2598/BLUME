...
public class LocalCartDataSource implements CartDataSource {
    ...
    @Override
    public Single<CartItem> getItemInCart(String flowerId, String uid) {
        return cartDAO.getItemInCart(flowerId,uid);
    }
    ...
    @Override
    public Single<CartItem> getItemWithAllOptionsInCart(String uid, String categoryId,String flowerId, String flowerAddon) {
        return cartDAO.getItemWithAllOptionsInCart(uid, categoryId,flowerId, flowerAddon);
    }
}
