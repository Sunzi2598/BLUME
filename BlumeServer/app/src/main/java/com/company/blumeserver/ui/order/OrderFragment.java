...
import com.company.blumeserver.Adapter.MyOrderAdapter;
import com.company.blumeserver.Adapter.MyShipperSelectionAdapter;
import com.company.blumeserver.Callback.IShipperLoadCallbackListener;
import com.company.blumeserver.Common.BottomSheetOrderFragment;
...
import com.company.blumeserver.TrackingOrderActivity;
...
public class OrderFragment extends Fragment implements IShipperLoadCallbackListener {
    ...
    private void initViews() {
        ...
        MySwipeHelper mySwipeHelper=new MySwipeHelper(getContext(),recycler_order,width/6){
            ...
            public void instantiateMyButton(RecyclerView.ViewHolder viewHolder, List<MyButton> buf) {
                ...
                buf.add(new MySwipeHelper.MyButton(getContext(),"Remove",30,0, Color.parseColor("#12005e"),
                        pos -> {
                            AlertDialog.Builder builder=new AlertDialog.Builder(getContext())
                                    .setTitle("Delete")
                                    .setMessage("Do you really want to delete this order?")
                                    .setNegativeButton("CANCEL", (dialogInterface, which) -> dialogInterface.dismiss()).setPositiveButton("DELETE", (dialogInterface, which) -> {
                                        OrderModel orderModel=adapter.getItemAtPosition(pos);
                ...
                buf.add(new MySwipeHelper.MyButton(getContext(),"Edit",30,0, Color.parseColor("#336699"),
                        pos -> {
    ...
    private void showEditDialog(OrderModel orderModel, int pos) {
        ...
        else showDialog(pos,orderModel,dialog,btn_ok,btn_cancel,rdi_shipping,rdi_shipped,rdi_cancelled,rdi_delete,rdi_restore_placed);
    ...
    private void loadShipperList(int pos, OrderModel orderModel, AlertDialog dialog, Button btn_ok, Button btn_cancel, RadioButton rdi_shipping, RadioButton rdi_shipped, RadioButton rdi_cancelled, RadioButton rdi_delete, RadioButton rdi_restore_placed) {
        ...
        shipperActive.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                iShipperLoadCallbackListener.onShipperLoadSuccess(pos,orderModel,templist,dialog,
                        btn_ok, btn_cancel,rdi_shipping,rdi_shipped,rdi_cancelled,rdi_delete,rdi_restore_placed);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                iShipperLoadCallbackListener.onShipperLoadFailed(error.getMessage());
            }
        });
    }
        ...
        btn_ok.setOnClickListener(view->{
            if (rdi_cancelled != null && rdi_cancelled.isChecked()){
                ...
                if(myShipperSelectedAdapter !=null){
                    ...
                    else Toast.makeText(getContext(), "Please select Shipper", Toast.LENGTH_SHORT).show();
                }
            }
                               ...
                               .addListenerForSingleValueEvent(new ValueEventListener() {
                                   ...
                                   public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                       if(dataSnapshot.exists()){
                                           ...
                                           notiData.put(Common.NOTI_TITLE,"You have a new order to be shipped");
                                           notiData.put(Common.NOTI_CONTENT,new StringBuilder("You have a new order to be shipped to")
                                                   .append(orderModel.getUserPhone()).toString());
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        if(dataSnapshot.exists()){
                                            ...
                                            compositeDisposable.add(ifcmService.sendNotification(sendData)
                                                    .subscribeOn(Schedulers.io())
                                                    .observeOn(AndroidSchedulers.mainThread())
                                                    .subscribe(fcmReponse -> {
                                                        dialog.dismiss();
                                                        if(fcmReponse.getSuccess()==1){
    ...
    public void onShipperLoadSuccess(int pos, OrderModel orderModel, List<ShipperModel> shipperModels, AlertDialog dialog, Button btn_ok, Button btn_cancel, RadioButton rdi_shipping, RadioButton rdi_shipped, RadioButton rdi_cancelled, RadioButton rdi_delete, RadioButton rdi_restore_placed) {
        if(recycler_shipper!=null){
            ...
            recycler_shipper.setLayoutManager(linearLayoutManager);
            recycler_shipper.addItemDecoration(new DividerItemDecoration(getContext(), linearLayoutManager.getOrientation()));
