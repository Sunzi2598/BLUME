...
import com.company.blumeserver.Callback.ISingleShippingOrderCallbackListener;
import com.company.blumeserver.Common.Common;
import com.company.blumeserver.Model.ShippingOrderModel;
import com.company.blumeserver.Remote.IGoogleAPI;
import com.company.blumeserver.Remote.RetrofitGoogleClient;
    ...
    //Add shipper
        if(shipperMarker==null){
            ...
            shipperMarker=mMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(resized))
                    .title(shippingOrderModel.getShipperName()).snippet(shippingOrderModel.getShipperPhone()).position(locationShipper).title("You"));
