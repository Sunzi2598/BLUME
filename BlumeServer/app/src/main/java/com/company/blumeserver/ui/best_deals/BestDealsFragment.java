...
import com.company.blumeserver.Adapter.MyBestDealsAdapter;
...
import com.company.blumeserver.ui.category.CategoryViewModel;
...
public class BestDealsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mViewModel.getBestDealMutableData().observe(this, bestDealModelList -> {
            dialog.dismiss();
        ...
        MySwipeHelper mySwipeHelper=new MySwipeHelper(getContext(),recycler_best_deal,200){
            ...
            public void instantiateMyButton(RecyclerView.ViewHolder viewHolder, List<MyButton> buf) {
                buf.add(new MyButton(getContext(),"Delete",30,0, Color.parseColor("#333639"),
                        pos -> {
                            Common.bestDealSelected=bestDealModels.get(pos);
                            showDeleteDialog();
    ...
    private void showUpdateDialog() {
        ...
        Glide.with(getContext()).load(Common.bestDealSelected.getImage()).into(img_best_deals);
