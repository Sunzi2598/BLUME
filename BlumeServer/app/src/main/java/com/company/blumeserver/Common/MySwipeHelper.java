...
import com.company.blumeserver.Callback.MyButtonClickListener;
...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private Map<Integer, List<MyButton>> buttonsBuffer;
    ...
    private void drawButtons(Canvas c, View itemView, List<MyButton> buffer, int pos, float dX){
    ...
    public abstract void instantiateMyButton(RecyclerView.ViewHolder viewHolder, List<MyButton> underlayButtons);
    ...
    public static class MyButton {
        ...
        public MyButton(Context context,String text, int textSize ,int imageResId, int color,  MyButtonClickListener clickListener) {
            this.text = text;
