...
public class MyCategoriesAdapter$MyViewHolder_ViewBinding implements Unbinder {
  private MyCategoriesAdapter.MyViewHolder target;

  @UiThread
  public MyCategoriesAdapter$MyViewHolder_ViewBinding(MyCategoriesAdapter.MyViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MyCategoriesAdapter.MyViewHolder target = this.target;
