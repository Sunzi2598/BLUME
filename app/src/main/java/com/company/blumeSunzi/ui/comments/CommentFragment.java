...
import com.company.blumeSunzi.Adapter.MyCommentAdapter;
import com.company.blumeSunzi.Callback.ICommentCallbackListener;
...
public class CommentFragment extends BottomSheetDialogFragment implements ICommentCallbackListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        commentViewModel.getMutableLiveDataFlowerList().observe(this,commentModels -> {
